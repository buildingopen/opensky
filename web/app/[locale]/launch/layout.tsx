...
export const metadata: Metadata = {
  title: "FlyFast is live — One sentence. Every flight.",
  description: "\"Anywhere warm under $300\" — just type what you want. No forms, no login, open source.",
  openGraph: {
    title: "FlyFast is live",
    description: "\"Anywhere warm under $300\" — just type what you want. Every airline searched.",
    url: "https://flyfast.app/launch",
    type: "video.other",
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: "FlyFast — One sentence. Every flight." }],

  ...
  return (
    <main className="min-h-[80vh] flex flex-col items-center justify-center px-4 text-center">
      <svg viewBox="0 0 32 32" className="w-12 h-12 mb-6" fill="none">
        <path d="M4 6L17 6L28 15L13 15Z" fill="var(--color-accent)" opacity={0.3} />
        <path d="M4 26L13 17L28 17L17 26Z" fill="var(--color-accent)" opacity={0.15} />
      </svg>
      ...
      >
        <svg viewBox="0 0 32 32" className="w-4 h-4" fill="none">
          <path d="M4 6L17 6L28 15L13 15Z" fill="currentColor" />
          <path d="M4 26L13 17L28 17L17 26Z" fill="currentColor" opacity="0.45" />
        </svg>
        Search flights
      </Link>
    </main>

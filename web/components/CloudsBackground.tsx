    ...
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0" aria-hidden="true">
      ...
      <div
        ...
        style={{
          ...
          top: "-50px",
          right: "-80px",
          background: "radial-gradient(ellipse, rgba(108,123,247,0.08) 0%, rgba(108,123,247,0.025) 40%, transparent 70%)",
          filter: "blur(50px)",
          animationDelay: "-3s",
      ...
      <div
        ...
        style={{
          ...
          bottom: "12%",
          left: "8%",
          background: "radial-gradient(ellipse, rgba(108,123,247,0.06) 0%, rgba(108,123,247,0.02) 40%, transparent 70%)",
          filter: "blur(40px)",
          animationDelay: "-9s",
